...
assuming that every fleet moves at the same \textbf{velocity} $v$:
...
\label{dedication}
\end{figure}
Contributions to the project have been constant since the 2nd of November of 2015. At least one contribution was made
every day since then, with only two days being the exception. Thus, progress was \textbf{constant}.
