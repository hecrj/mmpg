...
(see \autoref{state_of_the_art}) sponsored by \textbf{Google} during 2010. The game rules were simple:
\begin{enumerate}
\item
The game world consists of a determined number of planets.
\item
