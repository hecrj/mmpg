...
are made and fixing it becomes nightmare.
...
language chosen to implement the \textbf{\texttt{API}} is the \textbf{\texttt{Go}} programming language because it includes \textbf{native}
...
The \textbf{subscriber hub} keeps track of the different \textbf{client}s subscribed to the \textbf{\texttt{API}}, while
also allows to send data to subscribers.

This functionality was relatively easy to implement, thanks to the native concurrency in \textbf{Go} and the use of \textbf{WebSockets}.
