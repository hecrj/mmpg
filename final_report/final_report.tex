...
The \textbf{control panel} was a feature implemented in \autoref{control_panel}.
...
The objective has been achieved, but the planned objective was too simple and the control panel needs to be extended.
